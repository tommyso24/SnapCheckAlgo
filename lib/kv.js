...
// Fields returned in list view — excludes the heavy `intel` JSON blob
// (tens of KB per record with all search results and snippets).
// Full record including `intel` is fetched on-demand via getQueryById.
const LIST_FIELDS = [
  'userEmail',
  'url',
  'inquiry',
